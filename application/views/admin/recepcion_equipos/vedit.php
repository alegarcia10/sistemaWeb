                   ...
                   <div class="col-md-12">
                       <?php if($this->session->flashdata('error')):?>
                        ...
                        <div class="col-sm-2 form-group">
                                  ...
                                  <input type="date" id="txtfecha" name="txtfecha" min="1"  class="form-control" min="2020-01-01" max="2100-12-31" value="<?php echo !empty(form_error('txtfecha'))? set_value('txtfecha') :  date("d-m-Y", strtotime("$equiposedit->fecha"));?>" required >
                                </div>
