                        ...
                        <form action="<?php echo base_url();?>mantenimiento/corden/cupdate" method="POST">
                         ...
                         <div class=" col-sm-12 form-group">
                            ...
                            <div class="col-sm-3 form-group">
                                ...
                                <input type="datetime" id="txtfechaFactura" name="txtfechaFactura" class="form-control" min="2020-01-01" max="2100-12-31" value="<?php echo !empty(form_error('txtfechaFactura'))? set_value('txtfechaFactura') :  date("Y-m-d", strtotime("$facturas->fecha_factura"));?>" >
                            </div>
                            <div class="col-sm-3 form-group">
