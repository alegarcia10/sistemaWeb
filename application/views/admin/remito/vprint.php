                            ...
                            <p>Correo Electrónico: electronicabios@gmail.com</p>
                                    ...
                                    <div class="invoice-data">
                                        <h3>ORDEN RECEPCIÓN</h3>
                                            <h4>N°<?php echo $remitoedit->num_orden; ?></h4>
                        ...
                        <div class="customer-equipment">
                          ...
                          <h3>Datos del Cliente</h3>
                                ...
                                <div class="equipment">
                                    ...
                                    <p>Marca: <?php echo $remitoedit->marca;?> </p>
                                    <p>Modelo: <?php echo $remitoedit->modelo; ?></p>
                                    <p>N° de Serie: <?php echo $remitoedit->num_serie; ?></p>
                                    <p>Sector: <?php echo $remitoedit->sector; ?></p>
                                    <p>Accesorios: <?php echo $remitoedit->accesorios; ?></p>
                                </div>
                            </div>
                            <div class="divider"></div>
                            <div class="description">
                                ...
                                <p><?php echo $remitoedit->descripcion; ?></p>
